...
type UserService interface {
	...
	// 删
	DeletetUser(ctx context.Context, in *DeleteUserReq, opts ...client.CallOption) (*DeleteUserRep, error)
	// 改
...
func (c *userService) DeletetUser(ctx context.Context, in *DeleteUserReq, opts ...client.CallOption) (*DeleteUserRep, error) {
...
type UserServiceHandler interface {
	...
	// 删
	DeletetUser(context.Context, *DeleteUserReq, *DeleteUserRep) error
	// 改
...
func RegisterUserServiceHandler(s server.Server, hdlr UserServiceHandler, opts ...server.HandlerOption) error {
	type userService interface {
		...
		DeletetUser(ctx context.Context, in *DeleteUserReq, out *DeleteUserRep) error
...
func (h *userServiceHandler) DeletetUser(ctx context.Context, in *DeleteUserReq, out *DeleteUserRep) error {
